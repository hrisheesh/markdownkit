    ...
    <div className="markdown-render markdown-render-core min-w-0 text-[15px] font-normal leading-7 text-charcoal sm:text-[16px] sm:leading-8">
      <ReactMarkdown
        ...
        components={{
          ...
          table: ({ children }) => <div className="internal-scroll my-8 max-w-full overflow-x-auto rounded-xl border border-hairline bg-white"><table className="min-w-full w-max border-collapse text-left text-sm">{children}</table></div>,
          ...
          th: ({ children }) => <th className="whitespace-nowrap break-normal wrap-normal px-3 py-3 align-bottom font-bold sm:px-4">{children}</th>,
          td: ({ children }) => <td className="max-w-[28rem] whitespace-normal break-normal wrap-normal px-3 py-3 align-top text-charcoal sm:px-4">{children}</td>,
