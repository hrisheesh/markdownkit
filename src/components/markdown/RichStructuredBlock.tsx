...
function EmptyBlock({ title }: { title?: string }) {
  return <section className="rich-block-empty my-7 px-1 py-4"><BlockTitle title={title} /><p className="rich-block-copy">No items were provided for this section.</p></section>;
}
